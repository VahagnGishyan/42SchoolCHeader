...
void Test_CVectorInt::CopyData()
{
    ...
    c_vector_int_constructor(&strs2B);
    c_vector_int_constructor(&strs2A);

    //c_vector_int_constructor(&strd0);
    //c_vector_int_constructor(&strd1);
    //c_vector_int_constructor(&strd2B);
    //c_vector_int_constructor(&strd2A);

    /*Check 0*/
    int arrDest0[1];
    strs0.copy_intarray(&strs0, arrDest0, 0);
    int arrSorc0[1]{ 5 };
    ...
    strs2A.copy_intarray(&strs2A, arrSorc2A, 25);
    strs2B.copy_intarray(&strs2B, arrSorc2A, 0);
    strs2B.copy_c_vector_int(&strs2B, &strs2A);
    int number = 1;
 ...
 //   strd2B.copy_c_vector_int(&strd2B, &strd2A);
 ...
 //   }
    ...
    c_vector_int_destructor(&strs2A);
    c_vector_int_destructor(&strs2B);

    //c_vector_int_destructor(&strd0);
    //c_vector_int_destructor(&strd1);
    //c_vector_int_destructor(&strd2A);
    //c_vector_int_destructor(&strd2B);
