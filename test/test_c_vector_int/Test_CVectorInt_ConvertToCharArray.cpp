...
void Test_CVectorInt::ConvertToIntArray()
{
    ...
    //c_vector_int_constructor(&strd4A);
    //c_vector_int_constructor(&strd4B);
    //c_vector_int_constructor(&strd5A);
    //c_vector_int_constructor(&strd5B);
    //c_vector_int_constructor(&strd6A);
    //c_vector_int_constructor(&strd6B);
    //c_vector_int_constructor(&strd7A);
    //c_vector_int_constructor(&strd7B);
    ...
    //c_vector_int_destructor(&strd4A);
    //c_vector_int_destructor(&strd4B);
    //c_vector_int_destructor(&strd5A);
    //c_vector_int_destructor(&strd5B);
    //c_vector_int_destructor(&strd6A);
    //c_vector_int_destructor(&strd6B);
    //c_vector_int_destructor(&strd7A);
    //c_vector_int_destructor(&strd7B);
