...
void Test_CString::ToUpper()
{
    ...
    strs0A.to_upper_chararray(&strs0A, arr0B);
    ...
    strs1A.to_upper_chararray(&strs1A, arr1B);
    ...
    strs2A.to_upper_chararray(&strs2A, arr2B);
    ...
    strs3A.to_upper_chararray(&strs3A, arr3B);
    ...
    strs4A.to_upper_chararray(&strs4A, arr4B);
    ...
    strs5A.to_upper_chararray(&strs5A, arr5B);
    ...
    strd0A.to_upper_chararray(&strd0A, arrd0B);
    ...
    strd1A.to_upper_chararray(&strd1A, arrd1B);
    ...
    strd2A.to_upper_chararray(&strd2A, arrd2B);
    ...
    strd3A.to_upper_chararray(&strd3A, arrd3B);
    ...
    strd4A.to_upper_chararray(&strd4A, arrd4B);
    ...
    strd5A.to_upper_chararray(&strd5A, arrd5B);
