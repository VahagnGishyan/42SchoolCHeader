...
void Test_CSArrayInt::Search()
{
    ...
    c_sarray_int_constructor(&strs4);
    c_sarray_int_constructor(&strs5);

    //c_sarray_int_constructor(&strd0);
    //c_sarray_int_constructor(&strd1);
    //c_sarray_int_constructor(&strd2);
    //c_sarray_int_constructor(&strd3);
    //c_sarray_int_constructor(&strd4);
    //c_sarray_int_constructor(&strd5);
    //c_sarray_int_constructor(&strd6);
    //c_sarray_int_constructor(&strd7);
    ...
    int arrs1[1] = { 8 };
    int symbols1 = { 5 };
    strs1.set_data(&strs1, arrs1, 1, 1);
    ...
    int symbols2 = { 4 };
    strs2.set_data(&strs2, arrs2, 6, 128);
    ...
    int arrs3[1] = { 4 };
    int symbold0 = { 4 };
    strs3.set_data(&strs3, arrs3, 1, 1);
    ...
    int arrs4[1] = { 8 };
    int symbold1 = { 5 };
    strs4.set_data(&strs4, arrs4, 1, 1);
    ...
    int symbold3 = { 4 };
    strs5.set_data(&strs5, arrs5, 6, 128);
 ...
 //   }
    ...
    c_sarray_int_destructor(&strs4);
    c_sarray_int_destructor(&strs5);

    //c_sarray_int_destructor(&strd0);
    //c_sarray_int_destructor(&strd1);
    //c_sarray_int_destructor(&strd2);
    //c_sarray_int_destructor(&strd3);
    //c_sarray_int_destructor(&strd4);
    //c_sarray_int_destructor(&strd5);
    //c_sarray_int_destructor(&strd6);
    //c_sarray_int_destructor(&strd7);
