...
void Test_CSArrayInt::Concatenation()
{
    ...
    int arrs1A[128]{ 0 };
    int arrs1B[1]{ 1 };
    strs1.set_data(&strs1, arrs1A, 1, 128);
    ...
    strs2.set_data(&strs2, arrs2A, 1, 128);
