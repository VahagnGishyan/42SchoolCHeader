...
void Test_CSArrayInt::IndexOperators()
{
    ...
    //c_sarray_int_constructor(&str0);
    //c_sarray_int_constructor(&str1);
    //c_sarray_int_constructor(&str2);
    //c_sarray_int_constructor(&str3);
    //c_sarray_int_constructor(&str4);
    ...
    strs2.set_data(&strs2, arrs2, 25, 128);
    ...
    /*Check 3*/
    int arrs3[128]{ 1 };
    strs3.set_data(&strs3, arrs3, 1, 128);
    ...
    strs4.set_data(&strs4, arrs4, 5, 128);
 ...
 //   }
    ...
    //c_sarray_int_destructor(&str0);
    //c_sarray_int_destructor(&str1);
    //c_sarray_int_destructor(&str2);
    //c_sarray_int_destructor(&str3);
    //c_sarray_int_destructor(&str4);
