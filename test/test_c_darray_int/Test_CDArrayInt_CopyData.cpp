...
void Test_CDArrayInt::CopyData()
{
    ...
    c_darray_int_constructor(&strs2B);
    c_darray_int_constructor(&strs2A);

    //c_darray_int_constructor(&strd0);
    //c_darray_int_constructor(&strd1);
    //c_darray_int_constructor(&strd2B);
    //c_darray_int_constructor(&strd2A);
 ...
 //   }
    ...
    c_darray_int_destructor(&strs2A);
    c_darray_int_destructor(&strs2B);

    //c_darray_int_destructor(&strd0);
    //c_darray_int_destructor(&strd1);
    //c_darray_int_destructor(&strd2A);
    //c_darray_int_destructor(&strd2B);
