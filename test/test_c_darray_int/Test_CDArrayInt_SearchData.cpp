...
void Test_CDArrayInt::Search()
{
    ...
    c_darray_int_constructor(&strs4);
    c_darray_int_constructor(&strs5);

    //c_darray_int_constructor(&strd0);
    //c_darray_int_constructor(&strd1);
    //c_darray_int_constructor(&strd2);
    //c_darray_int_constructor(&strd3);
    //c_darray_int_constructor(&strd4);
    //c_darray_int_constructor(&strd5);
    //c_darray_int_constructor(&strd6);
    //c_darray_int_constructor(&strd7);
 ...
 //   }
    ...
    c_darray_int_destructor(&strs4);
    c_darray_int_destructor(&strs5);

    //c_darray_int_destructor(&strd0);
    //c_darray_int_destructor(&strd1);
    //c_darray_int_destructor(&strd2);
    //c_darray_int_destructor(&strd3);
    //c_darray_int_destructor(&strd4);
    //c_darray_int_destructor(&strd5);
    //c_darray_int_destructor(&strd6);
    //c_darray_int_destructor(&strd7);
