...
void Test_CVectorString::ConvertToIntArray()
{
    ...
    //t_c_vector_string strd4A;
    //t_c_vector_string strd4B;
    //t_c_vector_string strd5A;
    //t_c_vector_string strd5B;
    //t_c_vector_string strd6A;
    //t_c_vector_string strd6B;
    //t_c_vector_string strd7A;
    //t_c_vector_string strd7B;
    ...
    //t_c_vector_string_constructor(&strd4A);
    //t_c_vector_string_constructor(&strd4B);
    //t_c_vector_string_constructor(&strd5A);
    //t_c_vector_string_constructor(&strd5B);
    //t_c_vector_string_constructor(&strd6A);
    //t_c_vector_string_constructor(&strd6B);
    //t_c_vector_string_constructor(&strd7A);
    //t_c_vector_string_constructor(&strd7B);
    ...
    strs0.copy_string_array(&strs0, arrdst1, 4);
    ...
    //t_c_vector_string_destructor(&strd4A);
    //t_c_vector_string_destructor(&strd4B);
    //t_c_vector_string_destructor(&strd5A);
    //t_c_vector_string_destructor(&strd5B);
    //t_c_vector_string_destructor(&strd6A);
    //t_c_vector_string_destructor(&strd6B);
    //t_c_vector_string_destructor(&strd7A);
    //t_c_vector_string_destructor(&strd7B);
