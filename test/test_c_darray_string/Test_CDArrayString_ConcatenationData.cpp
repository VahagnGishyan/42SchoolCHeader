...
void Test_CDArrayString::Concatenation()
{
    ...
    strs1.copy_string_array(&strs1, arrdest1, 1);
    ...
    t_c_darray_string strs2A;
    t_c_darray_string strs2B;
    c_darray_string_constructor(&strs2A);
    c_darray_string_constructor(&strs2B);
    ...
    strs2B.set_data(&strs2B, arrdst2B, length6);
    strs2A.concatenation_c_darray_string(&strs2A, &strs2B);
    ...
    c_darray_string_destructor(&strs2A);
    c_darray_string_destructor(&strs2B);
    ...
    t_c_darray_string strs3A;
    t_c_darray_string strs3B;
    c_darray_string_constructor(&strs3A);
    c_darray_string_constructor(&strs3B);
    ...
    strs3A.set_data(&strs3A, arrdst3A, 2);
    strs3B.set_data(&strs3B, arrdst3B, 2);
    ...
    strs3A.concatenation_c_darray_string(&strs3A, &strs3B);
    for (int index = 0; index < 4; ++index)
    {
    ...
    c_darray_string_destructor(&strs3A);
    c_darray_string_destructor(&strs3B);
