...
void Test_CDArrayString::Search()
{
    std::cout << "\tSearch()\t\t";
    ...
    t_c_darray_string strs1;
    //t_c_darray_string strs2;
    //t_c_darray_string strs3;
    //t_c_darray_string strs4;
    //t_c_darray_string strs5;

    //t_c_darray_string strd0;
    //t_c_darray_string strd1;
    //t_c_darray_string strd2;
    //t_c_darray_string strd3;
    //t_c_darray_string strd4;
    //t_c_darray_string strd5;
    //t_c_darray_string strd6;
    //t_c_darray_string strd7;

    c_darray_string_constructor(&strs0);
    c_darray_string_constructor(&strs1);
    //t_c_darray_string_constructor(&strs2);
    //t_c_darray_string_constructor(&strs3);
    //t_c_darray_string_constructor(&strs4);
    //t_c_darray_string_constructor(&strs5);

    //t_c_darray_string_constructor(&strd0);
    //t_c_darray_string_constructor(&strd1);
    //t_c_darray_string_constructor(&strd2);
    //t_c_darray_string_constructor(&strd3);
    //t_c_darray_string_constructor(&strd4);
    //t_c_darray_string_constructor(&strd5);
    //t_c_darray_string_constructor(&strd6);
    //t_c_darray_string_constructor(&strd7);
    ...
    strs0.set_data(&strs0, arrdst0, 4);
    ...
    strs1.set_data(&strs1, arrdst1, 4);
 ...
 //   }
    ...
    c_darray_string_destructor(&strs1);
    //t_c_darray_string_destructor(&strs2);
    //t_c_darray_string_destructor(&strs3);
    //t_c_darray_string_destructor(&strs4);
    //t_c_darray_string_destructor(&strs5);

    //t_c_darray_string_destructor(&strd0);
    //t_c_darray_string_destructor(&strd1);
    //t_c_darray_string_destructor(&strd2);
    //t_c_darray_string_destructor(&strd3);
    //t_c_darray_string_destructor(&strd4);
    //t_c_darray_string_destructor(&strd5);
    //t_c_darray_string_destructor(&strd6);
    //t_c_darray_string_destructor(&strd7);
