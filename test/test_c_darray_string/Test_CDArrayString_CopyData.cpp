...
void Test_CDArrayString::CopyData()
{
    std::cout << "\tCopyData()\t\t";
    ...
    strs2B.copy_c_darray_string(&strs2B, &strs2A);
 ...
 //   strd2B.copy_t_c_darray_string(&strd2B, &strd2A);
 ...
 //   }
    ...
    //t_c_darray_string_destructor(&strd2A);
    //t_c_darray_string_destructor(&strd2B);
