...
void c_vector_int::concatenation_intarray(t_c_vector_int* str, int* arr, int size)
{
    int index;
...
void c_vector_int::concatenation_c_vector_int(t_c_vector_int* str_main, t_c_vector_int* str_other)
{
    int index;
