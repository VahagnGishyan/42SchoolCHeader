...
struct c_string
{
    ...
    void  (*copy_c_dstring)(t_c_string* str_main, t_c_dstring* str_other);
    ...
    void  (*convert_to_dstring)(t_c_string* str_main, t_c_dstring* str_other);
};
...
void  c_string_copy_c_dstring(t_c_string* str_main, t_c_dstring* str_other);
